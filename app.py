...
st.subheader("**KGs of C02 generated without VMware virtulisation**")
st.subheader(KG_CO2_No_Virtulisation)
...
st.subheader("**KGs of CO2 generated by ESXi Hosts**")
st.subheader(KG_CO2_ESXi)

MT_CO2_Saved = (KG_CO2_No_Virtulisation-KG_CO2_ESXi)

st.subheader("**KGs of CO2 saved through VMware virtulisation**")
st.subheader(MT_CO2_Saved)
...
fig.update_layout(title='Forecast Carbon Consumption, Virtulisation vs Non-Virtulisation',
                   xaxis_title='Year',
