...
st.write(KG_CO2_No_Virtulisation, "KGs of C02 generated without VMware virtulisation")
...
st.write(MT_CO2_Saved, "KGs of CO2 avoided through VMware virtulisation")
